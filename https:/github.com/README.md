Analiza czasu
Jest to jeden z pięciu programów które tworzą całość. Pozostałe programy znajdują się na tym githabie. Nazwy pozostałych repozytoriów to:
•	kaylogger
•	Tłumacz
•	Analiza
•	Nadzorujący
Program ma za zadanie na podstawie pliku wynikowego z programu analiza wyznaczyć uśrednione wyniki czasowe dla ciągów.
Program potrafi wytwarzać kilka najpopularniejszych statystyk jak dominanta czy odchylenie standardowe.
...
Instrukcja
•	Należy wybrać ścieżkę do pliku poprzez wciśnięcie guzika. Następnie należy wcisnąć załaduj plik.
